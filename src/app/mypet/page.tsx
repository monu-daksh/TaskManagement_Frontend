...
function MyPet() {
       return (
              ...
              <>
                     ...
                     <div className="w-full h-[50px] bg-[rgba(136,177,62,1)] flex items-center ">
                            <ul className="flex  items-center  ml-[116px]  gap-[22px] text-white">
                                   <li className="flex items-center gap-1">
                                          Home
                                          <Image src={images?.drawerIcon} alt="drawer" className="w-[6px] h-[6px] bg-[rgba(255, 255, 255, 0.5)]" />
                                   </li>
                                   <li className="flex items-center gap-1">Dogs
                                          <Image src={images?.drawerIcon} alt="drawer" className="w-[6px] h-[4px] bg-[rgba(255, 255, 255, 0.5)]" />
                                   </li>
                                   <li className="flex items-center gap-1">Cats
                                          <Image src={images?.drawerIcon} alt="drawer" className="w-[6px] h-[4px] bg-[rgba(255, 255, 255, 0.5)]" />
                                   </li>
                                   <li className="flex items-center gap-1">Ridings
                                          <Image src={images?.drawerIcon} alt="drawer" className="w-[6px] h-[4px] bg-[rgba(255, 255, 255, 0.5)]" />
                                   </li>
                                   <li>small pets</li>
                                   <li>Feed</li>
                     ...
                     <main className="w-full h-[358px]" >
                            <Image src={images.bannerImg} alt="banner" height={100} width={100} />
                     </main>
